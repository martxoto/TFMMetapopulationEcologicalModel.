...
int main(int argc, char* argv[])
{
    ...
    loadGamma("interactions/2interactions_Braunton_Burrows_patches.txt", plantIndex,insectIndex,plantCount,insectCount,numPatch,gamma);
    ...
    runLocalTargetExtinctionExperiment(p, v, gamma, h, plantCount, insectCount, numPatch, D);
